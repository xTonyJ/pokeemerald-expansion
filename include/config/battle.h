...
#define B_FLAG_NO_BAG_USE           0x265     // If this flag is set, the ability to use the bag in battle is disabled.
...
// Other settings
#define B_DOUBLE_WILD_CHANCE            50          // % chance of encountering two Pokémon in a Wild Encounter.
