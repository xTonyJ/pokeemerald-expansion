...
extern const u8 BattleScript_SapHealHP_Ret[];  // for the Sap status effect
extern const u8 BattleScript_MoveEffectSap[]; // for the Sap status effect
...
extern const u8 BattleScript_GrassyTerrainEnds2[];
