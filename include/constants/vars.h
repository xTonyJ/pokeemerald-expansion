...
#define VAR_BATTLE_CONTROLLER_PLAYER_F                   0x4067 // New - Elite Redux
...
#define VAR_FALLARBOR_BOTTLECAPS                         0x4083 // Used by Quest 5 to track bottle caps given
...
#define VAR_BIRCH_AIDES                                  0x408B // Var set to 1 after Roxxanne to give Boundless Candy, TODO, more birch aide buffs
