...
#define AI_SCRIPT_DO_NOT_SWITCH       (1 << 18)  // Zafnok - No Switching
#define AI_SCRIPT_PRESERVE_ORDER      (1 << 19)  // Preserving Order 
#define AI_FLAG_SMART_MON_CHOICES     (1 << 20)  // AI will make smarter decisions when choosing which mon to send out mid-battle and after a KO, which are separate decisions. Automatically included by AI_FLAG_SMART_SWITCHING.
