...
extern const u8 gText_Gorz_Welcome[];
extern const u8 gText_Gorz_WhichDifficulty[];
extern const u8 gText_Gorz_NormalMode[];
extern const u8 gText_Gorz_HardMode[];
extern const u8 gText_Gorz_ImpossibleMode[];
extern const u8 gText_Gorz_GrindingModes[];
extern const u8 gText_Gorz_MinGrinding[];
extern const u8 gText_Gorz_DefaultGrinding[];
extern const u8 gText_Gorz_WhichGrindingMode[];
extern const u8 gText_Gorz_Documents[];
...
extern const u8 gText_BirchImpossibleMode[];
extern const u8 gText_BirchDefault[];
extern const u8 gText_BirchMinGrinding[];
...
extern const u8 gText_GameCornerGastly[];
extern const u8 gText_GameCornerHoundour[];
extern const u8 gText_GameCornerRiolu[];
extern const u8 gText_GameCornerRalts[];
extern const u8 gText_GameCornerAron[];
extern const u8 gText_GameCornerGible[];
extern const u8 gText_GameCornerDitto[];
extern const u8 gText_GameCornerCubone[];
extern const u8 gText_GameCornerHonedge[];
extern const u8 gText_GameCornerSpiritomb[];
extern const u8 gText_GameCornerBagon[];
