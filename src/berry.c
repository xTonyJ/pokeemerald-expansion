...
void ObjectEventInteractionPickBerryTree(void)
{
    ...
    {
        gSpecialVar_0x8004 = AddBagItem(BerryTypeToItemId(berry), 5);
        return;
    }
    gSpecialVar_0x8004 = (CheckBagHasSpace(BerryTypeToItemId(berry), 5) && CheckBagHasSpace(BerryTypeToItemId(mutation), 1)) + 2;
    if (gSpecialVar_0x8004 == 3)
    {
        AddBagItem(BerryTypeToItemId(berry), 5);
