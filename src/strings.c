...
const u8 gText_BirchImpossibleMode[] = _("Impossible");
const u8 gText_BirchDefault[] = _("Default");
const u8 gText_BirchMinGrinding[] = _("Min. Grinding");
...
const u8 gText_RotomCatalog[] = _("Select a motor for\nRotom to imitate");
...
//subquests
const u8 gText_SubQuest1_Name1[] = _("Defeat Roxxanne");
...
const u8 gText_SubQuest1_Name9[] = _("Champion");
