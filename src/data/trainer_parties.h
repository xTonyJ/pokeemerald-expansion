...
static const struct TrainerMonItemCustomMoves sParty_GruntPetalburgWoods[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_EMBER, MOVE_THUNDER_FANG, MOVE_HOWL}
    },
    {
    .spread = SPREAD_15_IV_0_EV,
    .lvl = -3,
...
static const struct TrainerMonItemCustomMoves sParty_GruntRusturfTunnel[] = {
    ...
    .species = SPECIES_HOUNDOUR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_FIRE_FANG, MOVE_THUNDER_FANG, MOVE_HOWL}
    },
    {
    .spread = SPREAD_15_IV_0_EV,
    .lvl = -3,
    ...
    .heldItem = ITEM_POISON_GEM,
    .ability = 1, //Quick Feet
    .moves = {MOVE_BITE, MOVE_SWAGGER, MOVE_ICE_FANG, MOVE_POISON_FANG}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_PSYCHIC_TERRAIN, MOVE_FAKE_OUT, MOVE_FORCE_PALM}
    },
    {
    .spread = SPREAD_BRAWLY_ONE_MON,
    .lvl = -2,
    ...
    .moves = {MOVE_FOCUS_PUNCH, MOVE_SUBSTITUTE, MOVE_BULLET_SEED, MOVE_AERIAL_ACE}
    },
    {
    .spread = SPREAD_BRAWLY_ONE_MON,
    .lvl = -2,
    ...
    .moves = {MOVE_VENOSHOCK, MOVE_SUCKER_PUNCH, MOVE_LOW_KICK, MOVE_ICE_PUNCH}
    },
    {
    .spread = SPREAD_BRAWLY_ONE_MON,
    .lvl = -2,
    ...
    .ability = 1, //Iron Fist
    .moves = {MOVE_BULLET_PUNCH, MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH}
    },
    {
    .spread = SPREAD_BRAWLY_ONE_MON,
    .lvl = 0,
...
const struct TrainerMonNoItemDefaultMoves sParty_Calvin1[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_POOCHYENA,
...
//Trainer's starters are Houndour/Gastly


//Trainer's starters are Riolu/Ralts

//Trainer's starters are Aron / Gible
