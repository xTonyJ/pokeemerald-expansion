const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]             = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                                       {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_POLITOED}},
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_RHYDON]                = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_RHYPERIOR}},
#endif
    ...
    [SPECIES_SEADRA]                = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_KINGDRA}},
    [SPECIES_GOLDEEN]               = {{EVO_LEVEL, 33, SPECIES_SEAKING}},
    [SPECIES_STARYU]                = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]               = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_SCIZOR},
                                       {EVO_ITEM, ITEM_BLACK_AUGURITE, SPECIES_KLEAVOR}},
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_ELECTABUZZ]            = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]                = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_MAGMORTAR}},
#endif
    ...
    [SPECIES_PORYGON]               = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_PORYGON2}},
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_PORYGON2]              = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_PORYGON_Z}},
#endif
    ...
    [SPECIES_FEEBAS]                = {{EVO_BEAUTY, 170, SPECIES_MILOTIC},
                                       {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_MILOTIC}},
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_DUSCLOPS]              = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_DUSKNOIR}},
    ...
    [SPECIES_CLAMPERL]              = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_HUNTAIL},
                                       {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOREBYSS}},
    ...
    [SPECIES_LAIRON]                = {{EVO_LEVEL, 38, SPECIES_AGGRON}},
    ...
    [SPECIES_KARRABLAST]            = {{EVO_LEVEL, 35, SPECIES_ESCAVALIER}},
    ...
    [SPECIES_SHELMET]               = {{EVO_LEVEL, 35, SPECIES_ACCELGOR}},
    ...
    [SPECIES_SPRITZEE]              = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_AROMATISSE}},
    [SPECIES_SWIRLIX]               = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_SLURPUFF}},
    ...
    [SPECIES_PUMPKABOO_SMALL]       = {{EVO_LEVEL, 25, SPECIES_GOURGEIST_SMALL},
                                       {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE]       = {{EVO_LEVEL, 25, SPECIES_GOURGEIST_LARGE},
                                       {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER]       = {{EVO_LEVEL, 25, SPECIES_GOURGEIST_SUPER},
