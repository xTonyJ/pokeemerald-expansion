...
bool8 ScriptMenu_CreatePKMNCenterMoveTutorMultichoice(void)//InclementEmerald
{
    if (FuncIsActiveTask(Task_HandleMultichoiceInput) == TRUE)
    {
        return FALSE;
...
// Used to add more move tutor options as the player earns more badges - InclementEmerald
static void CreatePKMNCenterMoveListMultichoice(void)
{
    u8 selectionCount = 0;
    u8 count;
