...
const u16 gPPTextPalette2[] = INCBIN_U16("graphics/battle_interface/text_pp.gbapal");
...
const u32 gPPTextPalette[] = INCBIN_U32("graphics/battle_interface/text_pp.gbapal");
